...
python T5.py
```
See [T5.py](https://github.com/MN-Guan/T5-InterMRC/blob/main/STS/T5.py) script for more hyper-parameter modification.
## Results
...
The parameter file of the best model is displayed in [Data/Model_State](https://github.com/MN-Guan/T5-InterMRC/tree/main/STS/Data/Model_States) directory.

Subsequently, we will use the STS model to label the evidence. See [Reconstruct_Data.py](https://github.com/MN-Guan/T5-InterMRC/tree/main/MRC/Reconstruct_Data.py)
