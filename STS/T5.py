...
if __name__ == '__main__':
    ...
    parser.add_argument('--do_augment', action="store_true", help='Whether to expand the train dataset?')
    parser.add_argument('--do_divide', action="store_true", help='Whether to divide the gold label of train dataset?')
