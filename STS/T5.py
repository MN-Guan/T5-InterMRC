...
if __name__ == '__main__':
    ...
    parser.add_argument('--save_steps', type=int, default=20, help='The number of interval steps to save the model.')
    ...
    parser.add_argument('--do_augment', type=bool, default=True, help='Whether to expand the train dataset?')
    parser.add_argument('--do_divide', type=bool, default=True, help='Whether to divide the gold label of train dataset?')
